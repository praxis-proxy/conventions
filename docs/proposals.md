...
Proposals for new capabilities and refinements.
...
> development, the **How?** section does not require
> an upfront design document. Once the **What?** and
> **Why?** are agreed on, the **How?** can simply
> list the PRs that implement the solution. A full
...
proposal. Stakeholders are the people who need to be
kept informed and whose input is essential for the
proposal to succeed. An author may also be a
stakeholder.
...
> describe what must happen for it to become
> unblocked.
